...
<body class="p-6 text-gray-900">
    ...
    <p class="mb-4">
        Kami telah menerima pembayaran Anda untuk ID Invoice: <strong>{{ $billing->id }}</strong>.
    </p>
    ...
    <div class="p-4 mb-4 text-sm border rounded bg-gray-50">
        ...
        <p><strong>Jumlah Dibayar:</strong> Rp {{ number_format($billing->billing_fee + ($billing->fine ?? 0), 0, ',', '.') }}</p>
    </div>
