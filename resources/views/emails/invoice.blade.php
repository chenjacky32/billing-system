...
<body>
    ...
    <p>Dear <strong>{{ $billing->owner->owner_name }}</strong>,</p>
    ...
    <div class="invoice-container">
        ...
        <p><strong>Customer Name:</strong> {{ $billing->owner->owner_name }}</p>
        <p><strong>Phone Number:</strong> {{ $billing->owner->phone }}</p>
        <p><strong>Email Address:</strong> {{ $billing->owner->email }}</p>
